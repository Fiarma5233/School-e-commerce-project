...
class UserProfile(models.Model):
    ...
    address_line_1 = models.CharField(blank=True, max_length=100)
    address_line_2 = models.CharField(blank=True, max_length=100)
    profile_picture = CloudinaryField('image', folder='avatars', default='avatars/default_image_pro.png')  # Utiliser CloudinaryField
    city = models.CharField(blank=True, max_length=20)
    state = models.CharField(blank=True, max_length=20)
    country = models.CharField(blank=True, max_length=20)
    ...
    def get_profile_picture_url(self):
        if self.profile_picture:
            ...
            # Retourner une URL Cloudinary par défaut
            #return settings.MEDIA_URL + 'avatars/default_image_pro.png'

            return  "https://res.cloudinary.com/dtkv3enkn/image/upload/v1740849688/default_image_pro_dhfcnj.png"